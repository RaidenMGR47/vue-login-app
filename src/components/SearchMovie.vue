...
.movie-card { border: 1px solid #e0e0e0; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.05); transition: transform 0.2s, box-shadow 0.2s; overflow: hidden; display: flex; flex-direction: column; }
.movie-card:hover { transform: translateY(-5px); box-shadow: 0 8px 16px rgba(0,0,0,0.1); }
.movie-poster { width: 100%; height: 330px; object-fit: cover; }
.movie-info { padding: 1rem; display: flex; flex-direction: column; flex-grow: 1; }
...
.purchase-form input, .purchase-form select { width: 100%; padding: 8px; margin-top: 4px; border-radius: 5px; border: 1px solid #ccc; }
.total-price { font-size: 1.5em; font-weight: bold; text-align: right; margin-top: 1rem; }
.modal-actions { display: flex; justify-content: flex-end; gap: 1rem; margin-top: 2rem; }
.confirm-button, .download-button { background-color: #28a745; color: white; }
.cancel-button { background-color: #6c757d; color: white; }
.modal-actions button { border: none; padding: 12px 20px; border-radius: 5px; cursor: pointer; font-size: 1em; }
.purchase-success { text-align: center; }
.receipt-code { font-size: 1.2em; margin: 1rem 0; }
.qr-container { padding: 15px; background: white; display: inline-block; margin-top: 10px; border: 1px solid #ddd; }
</style>
